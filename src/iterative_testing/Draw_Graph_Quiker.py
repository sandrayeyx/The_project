...
from project_paths import NE_DATA_ROOT
...
class SatelliteVisualizer_geo:
    def __init__(self, edge_color=False):
        self.edge_color = edge_color
        world_path = NE_DATA_ROOT / "ne_50m_admin_0_countries_lakes.shp"
        if not world_path.exists():
            raise FileNotFoundError(f"World map data file not found: {world_path}")
